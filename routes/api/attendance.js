...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const configuredRisetWeeklyTargetHours = Number(attendanceRules.risetTargetWeeklyHours || 6);
    const configuredRisetWeeklyMinHours = Number(attendanceRules.risetMinWeeklyHours || 4);
